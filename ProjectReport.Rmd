...
## FL Package
We created a federated learning package “FL” that is hosted on github (https://github.com/JusticeAkuoko-Frimpong/FL).  This package facilitates the federated learning analysis in a modular format with 3 key functions. 
...
\[
\text{{Billing Amount}} \sim \text{{Age}} + \text{{Agesq}} + \text{{Gender}} + \text{{Medical Condition}} + \text{{Admission Type}} + \text{{Medication}} + \text{{length.of.stay}} + \text{{length.of.stay}} \times \text{{Medical Condition}}
\]
