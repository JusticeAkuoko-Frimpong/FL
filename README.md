...
## Description
The FL package provides a comprehensive functions to implement federated learning procedures. The package is designed to be user-friendly.It provides functions to compute local summaries of servers, a different function to combine these summaries and a final fucntion to fit a linear regression mdoel. It provides estimates of the Regression coefficients, standard error, t values, p values.
